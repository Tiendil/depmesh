...
- `expected error` — an operational failure represented by a shared `EnvironmentError` model and returned through `Result`, including project-owned and shared-library errors.
